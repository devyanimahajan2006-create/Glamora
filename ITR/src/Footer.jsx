    ...
    <footer style={styles.footer}>
      <div style={styles.container}>
        ...
        <div style={styles.column}>
          <h4 style={styles.heading}>About Glamora</h4>
          <ul style={styles.list}>
            <li>
              <Link to="/about" style={styles.link}>Our Story</Link> {/* ✅ Navigate to About page */}
            </li>
            <li>
              <Link to="/hfome" style={styles.link}>Back to Glamora</Link>
            </li>
          </ul>
        </div>
      ...
      <div style={styles.bottom}>
        <p style={styles.copyText}>&copy; 2025 Glamora. All rights reserved.</p>
      </div>
    </footer>
  );
};
